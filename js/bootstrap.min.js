...
+function (t) {
    ...
    i.VERSION = "3.3.5", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var r = "function" == typeof this.options.placement ? this.options.placement.call(this, s[0], this.$element[0]) : this.options.placement, l = /\s?auto?\s?/i, p = l.test(r);
            p && (r = r.replace(l, "") || "top"), s.detach().css({
                top: 0,
                left: 0,
                display: "block"
            }).addClass(r).data("bs." + this.type, this), this.options.container ? s.appendTo(this.options.container) : s.insertAfter(this.$element), this.$element.trigger("inserted.bs." + this.type);
            var h = this.getPosition(), c = s[0].offsetWidth, d = s[0].offsetHeight;
            if (p) {
                var u = r, f = this.getPosition(this.$viewport);
                r = "bottom" == r && h.bottom + d > f.bottom ? "top" : "top" == r && h.top - d < f.top ? "bottom" : "right" == r && h.right + c > f.width ? "left" : "left" == r && h.left - c < f.left ? "right" : r, s.removeClass(u).addClass(r)
            }
            var g = this.getCalculatedOffset(r, h, c, d);
        ...
        var c = /top|bottom/.test(i), d = c ? 2 * h.left - n + l : 2 * h.top - s + p, u = c ? "offsetWidth" : "offsetHeight";
        o.offset(e), this.replaceArrow(d, o[0][u], c)
